...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ContactHolder> {
    ...
    private ArrayList<Hospital> contactsList;

    // Counstructor for the Class
    public MyAdapter(ArrayList<Hospital> contactsList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ContactHolder holder, final int position) {
        final Hospital contact = contactsList.get(position);
